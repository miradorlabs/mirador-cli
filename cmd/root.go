...
pins one project and skips the browser entirely.`,
	...
	// Endpoint overrides. Undocumented in the command list on purpose: they exist for
	// self-hosted deployments and Mirador's own pre-production, not for everyday use.
